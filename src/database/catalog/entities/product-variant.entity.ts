// File này lưu SKU/variant của catalog và giữ relation đến inventory ở boundary persistence.
// Logic reserve/release tồn kho thuộc Checkout domain, không đặt trong entity này.
import {
  Column,
  CreateDateColumn,
  Entity,
...
import { ProductVariantStatus } from "../enums/product-variant-status.enum";
