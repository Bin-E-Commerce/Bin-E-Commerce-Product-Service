...
export class AddReviewLikesAndPublishVerifiedReviews2026090100020 implements MigrationInterface {
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(
            `DROP INDEX IF EXISTS "IDX_product_review_likes_review"`,
        );
        await queryRunner.query(
            `DROP INDEX IF EXISTS "UQ_product_review_likes_review_user"`,
        );
