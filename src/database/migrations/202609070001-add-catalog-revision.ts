...
export class AddCatalogRevision202609070001 implements MigrationInterface {
  ...
  async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`ALTER TABLE "products" ADD COLUMN IF NOT EXISTS "catalog_revision" bigint NOT NULL DEFAULT 1`);
  }

  // Rollback chỉ xóa field Phase 3, không động vào product data khác.
  async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`ALTER TABLE "products" DROP COLUMN IF EXISTS "catalog_revision"`);
  }
}
