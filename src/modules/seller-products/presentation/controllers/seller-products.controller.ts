...
import { ListSellerProductsQueryDto } from '@/modules/seller-products/presentation/dto/queries/list-seller-products-query.dto';
import { UpdateSellerProductDto } from '@/modules/seller-products/presentation/dto/update-product/update-seller-product.dto';
...
import type { CreateProductResponse } from '@/modules/seller-products/application/types/create-product-response.type';
import type { SellerProductListResponse } from '@/modules/seller-products/application/types/seller-product-list-response.type';
import type { UpdateProductResponse } from '@/modules/seller-products/application/types/update-product-response.type';
import type { DeleteProductResponse } from '@/modules/seller-products/application/types/delete-product-response.type';
import type { ChangeProductStatusResponse } from '@/modules/seller-products/application/types/change-product-status-response.type';
import type { RestoreProductResponse } from '@/modules/seller-products/application/types/restore-product-response.type';
import { ChangeSellerProductStatusDto } from '@/modules/seller-products/presentation/dto/change-status/change-seller-product-status.dto';
import { ApplyAiMediaDto } from '@/modules/seller-products/presentation/dto/ai-media/apply-ai-media.dto';
...
import type { AiMediaMutationResponse } from '@/modules/seller-products/application/types/ai-media-response.type';
...
export class SellerProductsController {
    ...
    applyAiMedia(
        ...
        const currentUser =
            this.sellerProductAccessService.buildCurrentUserFromHeaders(
                headers,
            );
        const authorizedUser =
            this.sellerProductAccessService.ensureCanApplyAiImage(currentUser);
        return this.sellerProductAiMediaService.apply(
            authorizedUser,
            productId,
            dto,
        );
    ...
    rollbackAiMedia(
        ...
        const authorizedUser =
            this.sellerProductAccessService.ensureCanRollbackAiImage(
                currentUser,
            );
        return this.sellerProductAiMediaService.rollback(
            authorizedUser,
            productId,
            jobId,
        );
    ...
    deleteOwnedProduct(
        ...
        return this.sellerProductDeletionService.delete(
            authorizedUser,
            productId,
        );
    }
    ...
    restoreOwnedProduct(
        ...
        const authorizedUser =
            this.sellerProductAccessService.ensureCanRestoreProduct(
                currentUser,
            );

        return this.sellerProductRestoreService.restore(
            authorizedUser,
            productId,
        );
    }
    ...
    changeOwnedProductStatus(
        ...
        const authorizedUser =
            this.sellerProductAccessService.ensureCanChangeProductStatus(
                currentUser,
            );
