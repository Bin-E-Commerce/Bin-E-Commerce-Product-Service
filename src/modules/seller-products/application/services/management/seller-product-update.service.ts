...
} from "../../../presentation/dto/update-product/update-seller-product.dto";
import { CatalogClient } from "../../clients/catalog.client";
import { ProductMediaClient } from "../../clients/product-media.client";
    ...
    await manager.save(
      ...
      dto.images.map((image) => {
        ...
        const parsedSourceAssetId =
          parseProductMediaReference(imageUrl, "product_image")?.assetId ??
          null;
