...
import { CheckoutInventoryService } from '@/modules/checkout-inventory/application/services/checkout-inventory.service';
...
export class CheckoutInventoryController {
    ...
    // Quote đọc snapshot giá và kiện hàng mà không lock hoặc trừ tồn kho.
    @Post('quote')
    quote(@Body() dto: ReserveCheckoutDto) {
        return this.checkoutInventoryService.quote(dto);
    }
