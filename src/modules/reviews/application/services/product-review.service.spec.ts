...
import { CreateProductReviewDto } from '@/modules/reviews/presentation/dto/create-product-review.dto';
...
import type {
    ReviewItemProof,
    ReviewOrderContext,
} from '@/modules/reviews/application/types/review-order-context.type';
...
describe('ProductReviewService', () => {
        ...
        const module: TestingModule = await Test.createTestingModule({
            providers: [
                ProductReviewService,
                {
                    ...
                    useValue: mockReviews,
                },
                {
                    provide: getRepositoryToken(ProductReviewLike),
                    useValue: mockLikes,
                },
    ...
    it('should create a verified purchase review', async () => {
        ...
        mockReviews.create.mockImplementation(
            (input) => input as ProductReview,
        );
    ...
    it('should like an approved review idempotently', async () => {
        ...
        mockLikes.create.mockImplementation(
            (input) => input as ProductReviewLike,
        );
